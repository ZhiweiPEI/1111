...
<html class="x-admin-sm">
    <head>
        ...
        <!-- <script src="{{asset('js/admin/x-login-session.js')}}"></script> -->
        <script src="{{asset('js/admin/layui.js')}}" charset="utf-8"></script>
        <script type="text/javascript" src="{{asset('js/admin/xadmin.js')}}"></script>
        <script type="text/javascript" src="{{asset('js/admin/x-index.js')}}"></script>
        <!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
        <!--[if lt IE 9]>
    ...
    <body class="index">
        ...
        <div class="container">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    <a href="javascript:;" id="loginName">admin</a>
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
                        ...
                        <dd>
                            <a onclick="logout()" href="./login.html">退出</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item to-index">
                    <a href="../html/home.html">前台首页</a></li>
            </ul>
        </div>
        <!-- 顶部结束 -->
        <!-- 中部开始 -->
            ...
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('用户管理','user/member-list.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户管理</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('角色管理','role/role-list.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>角色管理</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('权限管理','permission/permission-list.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>权限管理</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="导航信息">&#xe6f2;</i>
                            <cite>导航信息</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('导航信息','nav/nav-list.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>导航信息</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="公司信息">&#xe6da;</i>
                            <cite>公司信息</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('公司信息','manager/admin-list.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>公司信息</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('新闻管理','news/news-list.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>新闻管理</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
<!--                            <li>-->
<!--                                <a onclick="xadmin.add_tab('产品管理','user/role-list.html')">-->
<!--                                    <i class="iconfont">&#xe6a7;</i>-->
<!--                                    <cite>产品管理</cite></a>-->
<!--                            </li>-->
                            <li>
                                <a onclick="xadmin.add_tab('产品列表','product/product-list.html',true)">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>产品列表</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('留言列表','message/message-list.html',true)">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>留言列表</cite></a>
                            </li>
                        </ul>
